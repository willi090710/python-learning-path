...
- A simple script to calculate movie ticket prices based on age and seat category.
- Goal: Practice `if/else` logic and mathematical operators.

Server Health Checker
- a simulation tool to check the status of virtual servers via user input.
- Goal: Practice user input handling (`input()`) and program flow control.
